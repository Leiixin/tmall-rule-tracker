  ...
  shelf: {
    ...
    cards: [
      ...
      },
      {
        ...
        tags: ["保质期", "禁售"],
        link: SHELF_ARTICLE_URL,
        body: "<ul><li>保质期以月/年换算：1月=<span class=\"num\">30</span>天，1年=<span class=\"num\">365</span>天，临期天数向上取整</li><li>365天≤保质期：剩余≤<span class=\"num\">45</span>天为临期；180～365天：≤<span class=\"num\">30</span>天；90～180天：≤<span class=\"num\">20</span>天</li><li>国家/地区标准严于平台时，按更严标准执行</li><li>来源：《商品保质期管理和宣传规范》3.2</li></ul>",
        sourceId: "dy-rule-aJk964FFQKKZ",
        cardId: "shelf:1"
      },
      {
